...
Este é um sistema simples de bolão para a fase final da Copa do Mundo, englobando as fases de **Quartas de Final, Semifinais, Disputa de 3º lugar e Final** (8 seleções, 8 partidas).
